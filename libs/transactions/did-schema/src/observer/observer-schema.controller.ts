...
import { DidSchemaTransaction } from '@tc/did-schema/schemas/did-schema-transaction.schema';
...
import { SchemaDocResponse } from '@tc/did-schema/dto/schema-doc-response.dto';
