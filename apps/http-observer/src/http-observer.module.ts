...
import { ObserverDidModule } from '@tc/did-id/observer/observer-did.module';
import { ObserverHashModule } from '@tc/did-hash/observer/observer-hash.module';
import { ObserverSchemaModule } from '@tc/did-schema/observer/observer-schema.module';
import { ObserverTemplateModule } from '@tc/did-template/observer/observer-template.module';
